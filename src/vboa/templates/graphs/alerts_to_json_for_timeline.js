...
var source_alerts = [
    ...
    {% set severity_label=alert.alertDefinition.severity|get_severity_label %}
    {
        ...
        "alert_uuid": "<a href='/eboa_nav/query-source-alert/" + "{{ alert.source_alert_uuid }}" + "'>" + "{{ alert.source_alert_uuid }}" + "</a>",
...
var event_alerts = [
    ...
    {% set severity_label=alert.alertDefinition.severity|get_severity_label %}
    {
        ...
        "notification_time": "{{ alert.notification_time.isoformat() }}",
        "justification": "{{ alert.justification }}",
        "alert_uuid": "<a href='/eboa_nav/query-event-alert/" + "{{ alert.event_alert_uuid }}" + "'>" + "{{ alert.event_alert_uuid }}" + "</a>",
...
var annotation_alerts = [
    ...
    {% set severity_label=alert.alertDefinition.severity|get_severity_label %}
    {
        ...
        "notification_time": "{{ alert.notification_time.isoformat() }}",
        "justification": "{{ alert.justification }}",
        "alert_uuid": "<a href='/eboa_nav/query-annotation-alert/" + "{{ alert.annotation_alert_uuid }}" + "'>" + "{{ alert.annotation_alert_uuid }}" + "</a>",
...
var report_alerts = [
    ...
    {% set severity_label=alert.alertDefinition.severity|get_severity_label %}
    {
        ...
        "notification_time": "{{ alert.notification_time.isoformat() }}",
        "justification": "{{ alert.justification }}",
        "alert_uuid": "<a href='/rboa_nav/query-report-alert/" + "{{ alert.report_alert_uuid }}" + "'>" + "{{ alert.report_alert_uuid }}" + "</a>",
...
var er_alerts = [
    ...
    {% set severity_label=alert.alertDefinition.severity|get_severity_label %}
    {
        ...
        "notification_time": "{{ alert.notification_time.isoformat() }}",
        "justification": "{{ alert.justification }}",
        "alert_uuid": "<a href='/eboa_nav/query-er-alert/" + "{{ alert.explicit_ref_alert_uuid }}" + "'>" + "{{ alert.explicit_ref_alert_uuid }}" + "</a>",
