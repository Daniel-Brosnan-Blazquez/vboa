...
class TestGeneralViewAlerts(unittest.TestCase):
    ...
    def test_sources_alerts_query_no_filter(self):
        ...
        alerts = [
            ...
            {
                "alert_uuid": "<a href='/eboa_nav/query-alert/" + str(sources_alerts[1].source_alert_uuid) + "'>" + str(sources_alerts[1].source_alert_uuid) + "</a>",
                "description": "Alert description",
                "entity": "Source",
                "entity_uuid": "<a href='/eboa_nav/query-source/" + str(sources_alerts[1].source_uuid) + "'>" + str(sources_alerts[1].source_uuid) + "</a>",
                "generator": "test1",
                "group": "SOURCES;alert_group",
                "group_alert": "alert_group",
                "id": str(sources_alerts[1].source_alert_uuid),
                "ingestion_time": sources_alerts[1].ingestion_time.isoformat(),
                "justification": "None",
                "message": "Alert message",
                "name": "alert_name2",
                "notification_time": "2019-06-06T08:07:36",
                ...
                "solved": "<span class='bold-orange'>None</span>",
                "solved_time": "None",
                "start": "2019-06-06T08:07:36",
                "stop": "2019-06-06T08:07:36",
        ...
        # Row 2
        justification = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[1]")

        assert justification.text == "None"

        severity = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[2]")

        assert severity.text == "critical"

        group = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[3]")

        assert group.text == "alert_group"

        name = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[4]")

        assert name.text == "alert_name2"

        message = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[5]")

        assert message.text == "Alert message"

        notification_time = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[6]")

        assert notification_time.text == "2019-06-06T08:07:36"

        solved = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[7]")

        assert solved.text == "None"

        solved_time = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[8]")

        assert solved_time.text == "None"

        description = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[9]")

        assert description.text == "Alert description"

        validated = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[10]")

        assert validated.text == "None"

        generator = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[11]")

        assert generator.text == "test1"

        notified = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[12]")

        assert notified.text == "None"

        ingestion_time = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[13]")

        assert ingestion_time.text == sources_alerts[1].ingestion_time.isoformat()

        alert_uuid = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[14]")

        assert alert_uuid.text == str(sources_alerts[1].source_alert_uuid)

        source_uuid = source_alerts_table.find_element_by_xpath("tbody/tr[2]/td[15]")

        assert source_uuid.text == str(sources_alerts[1].source_uuid)
    ...
    def test_events_alerts_query_no_filter(self):
        ...
        assert summary_number_alerts and summary_number_alerts.text == "4"
        ...
        alerts = [
            ...
            {
                "alert_uuid": "<a href='/eboa_nav/query-alert/" + str(events_alerts[3].event_alert_uuid) + "'>" + str(events_alerts[3].event_alert_uuid) + "</a>",
                "description": "Alert description",
                "entity": "Event",
                "entity_uuid": "<a href='/eboa_nav/query-event-links/" + str(events_alerts[3].event_uuid) + "'>" + str(events_alerts[3].event_uuid) + "</a>",
                "generator": "test2",
                "group": "EVENTS;alert_group2",
                "group_alert": "alert_group2",
                "id": str(events_alerts[3].event_alert_uuid),
                "ingestion_time": events_alerts[3].ingestion_time.isoformat(),
                "justification": "None",
                "message": "Alert message",
                "name": "alert_name3",
                "notification_time": "2019-06-05T08:07:36",
        ...
        # Row 4
        justification = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[1]")

        assert justification.text == "None"

        severity = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[2]")

        assert severity.text == "major"

        group = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[3]")

        assert group.text == "alert_group2"

        name = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[4]")

        assert name.text == "alert_name3"

        message = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[5]")

        assert message.text == "Alert message"

        notification_time = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[6]")

        assert notification_time.text == "2019-06-05T08:07:36"

        solved = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[7]")

        assert solved.text == "None"

        solved_time = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[8]")

        assert solved_time.text == "None"

        description = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[9]")

        assert description.text == "Alert description"

        validated = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[10]")

        assert validated.text == "None"

        generator = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[11]")

        assert generator.text == "test2"

        notified = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[12]")

        assert notified.text == "None"

        ingestion_time = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[13]")

        assert ingestion_time.text == events_alerts[3].ingestion_time.isoformat()

        alert_uuid = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[14]")

        assert alert_uuid.text == str(events_alerts[3].event_alert_uuid)

        event_uuid = event_alerts_table.find_element_by_xpath("tbody/tr[4]/td[15]")

        assert event_uuid.text == str(events_alerts[3].event_uuid)
    ...
    def test_annotations_alerts_query_no_filter(self):
        ...
        alerts = [
            ...
            {
                "alert_uuid": "<a href='/eboa_nav/query-alert/" + str(annotations_alerts[2].annotation_alert_uuid) + "'>" + str(annotations_alerts[2].annotation_alert_uuid) + "</a>",
                "description": "Alert description",
                "entity": "Annotation",
                "entity_uuid": "<a href='/eboa_nav/query-annotation/" + str(annotations_alerts[2].annotation_uuid) + "'>" + str(annotations_alerts[2].annotation_uuid) + "</a>",
                "generator": "test",
                "group": "ANNOTATIONS;alert_group",
                "group_alert": "alert_group",
                "id": str(annotations_alerts[2].annotation_alert_uuid),
                "ingestion_time": annotations_alerts[2].ingestion_time.isoformat(),
                "justification": "None",
                "message": "Alert message",
                "name": "alert_name1",
                "notification_time": "2018-06-05T08:07:36",
            ...
            {
                "alert_uuid": "<a href='/eboa_nav/query-alert/" + str(annotations_alerts[3].annotation_alert_uuid) + "'>" + str(annotations_alerts[3].annotation_alert_uuid) + "</a>",
                "description": "Alert description",
                "entity": "Annotation",
                "entity_uuid": "<a href='/eboa_nav/query-annotation/" + str(annotations_alerts[3].annotation_uuid) + "'>" + str(annotations_alerts[3].annotation_uuid) + "</a>",
                "generator": "test2",
                "group": "ANNOTATIONS;alert_group2",
                "group_alert": "alert_group2",
                "id": str(annotations_alerts[3].annotation_alert_uuid),
                "ingestion_time": annotations_alerts[3].ingestion_time.isoformat(),
                "justification": "None",
                "message": "Alert message",
                "name": "alert_name2",
                "notification_time": "2019-06-05T08:07:36",
        ...
        # Row 3
        justification = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[1]")

        assert justification.text == "None"

        severity = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[2]")

        assert severity.text == "critical"

        group = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[3]")

        assert group.text == "alert_group"

        name = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[4]")

        assert name.text == "alert_name1"

        message = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[5]")

        assert message.text == "Alert message"

        notification_time = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[6]")

        assert notification_time.text == "2018-06-05T08:07:36"

        solved = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[7]")

        assert solved.text == "None"

        solved_time = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[8]")

        assert solved_time.text == "None"

        description = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[9]")

        assert description.text == "Alert description"

        validated = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[10]")

        assert validated.text == "None"

        generator = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[11]")

        assert generator.text == "test"

        notified = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[12]")

        assert notified.text == "None"

        ingestion_time = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[13]")

        assert ingestion_time.text == annotations_alerts[2].ingestion_time.isoformat()

        alert_uuid = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[14]")

        assert alert_uuid.text == str(annotations_alerts[2].annotation_alert_uuid)

        annotation_uuid = annotation_alerts_table.find_element_by_xpath("tbody/tr[3]/td[15]")

        assert annotation_uuid.text == str(annotations_alerts[2].annotation_uuid)

        # Row 4
        justification = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[1]")

        assert justification.text == "None"

        severity = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[2]")

        assert severity.text == "major"

        group = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[3]")

        assert group.text == "alert_group2"

        name = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[4]")

        assert name.text == "alert_name2"

        message = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[5]")

        assert message.text == "Alert message"

        notification_time = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[6]")

        assert notification_time.text == "2019-06-05T08:07:36"

        solved = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[7]")

        assert solved.text == "None"

        solved_time = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[8]")

        assert solved_time.text == "None"

        description = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[9]")

        assert description.text == "Alert description"

        validated = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[10]")

        assert validated.text == "None"

        generator = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[11]")

        assert generator.text == "test2"

        notified = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[12]")

        assert notified.text == "None"

        ingestion_time = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[13]")

        assert ingestion_time.text == annotations_alerts[3].ingestion_time.isoformat()

        alert_uuid = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[14]")

        assert alert_uuid.text == str(annotations_alerts[3].annotation_alert_uuid)

        annotation_uuid = annotation_alerts_table.find_element_by_xpath("tbody/tr[4]/td[15]")

        assert annotation_uuid.text == str(annotations_alerts[3].annotation_uuid)
        ...
        alerts = [
            {
                ...
                "generator": "test",
                "group": "EXPLICIT_REFERENCES;alert_group",
                "group_alert": "alert_group",
            ...
            },
            {
                ...
                "generator": "test2",
                "group": "EXPLICIT_REFERENCES;alert_group2",
                "group_alert": "alert_group2",
